...
#    s{([_a-zA-Z][_a-zA-Z0-9]*)\s+MCS51_STORED_IN_RAM}{$1_xdata}g;
    ...
    s{WHIP6_MICROC_EXTERN_DECL_SUFFIX}{__attribute__((banked))}g;
    s{WHIP6_MICROC_EXTERN_DEF_PREFIX}{}g;
    s{WHIP6_MICROC_EXTERN_DEF_SUFFIX}{__attribute__((banked))}g;
    ...
    s{WHIP6_MICROC_INLINE_DECL_PREFIX}{inline}g;
    s{WHIP6_MICROC_INLINE_DECL_SUFFIX}{}g;
    s{WHIP6_MICROC_INLINE_DEF_PREFIX}{inline}g;
