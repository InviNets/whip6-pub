...
implementation {
    ...
    components new HalGenericSpiPrv(SSI1_BASE) as GenericSpi;
    GenericSpi.Interrupt -> HplSSIInterruptsPub.SSI1Interrupt;
    GenericSpi.TXChannel -> HalDMAPub.DMAChannel[UDMA_CHAN_SSI1_TX];
    GenericSpi.RXChannel -> HalDMAPub.DMAChannel[UDMA_CHAN_SSI1_RX];

    components HalSPI1PinsPub as Pins;
    components new HalConfigureSPIMasterPrv(SSI1_BASE) as Configure;
    ...
    components new FcfsArbiterPub(RESOURCE_SPI1) as Arbiter;
